  ...
  & { search: (
    ...
    & { edges?: Maybe<Array<Maybe<(
      ...
      & { node?: Maybe<{ __typename?: 'App' } | { __typename?: 'Issue' } | { __typename?: 'MarketplaceListing' } | { __typename?: 'Organization' } | { __typename?: 'PullRequest' } | (
        { __typename?: 'Repository' }
        & Pick<Repository, 'nameWithOwner' | 'forkCount' | 'homepageUrl' | 'createdAt' | 'pushedAt' | 'updatedAt'>
        & { primaryLanguage?: Maybe<(
          ...
          { __typename?: 'IssueConnection' }
          & Pick<IssueConnection, 'totalCount'>
        ), commitsCount?: Maybe<{ __typename?: 'Blob' } | (
          { __typename?: 'Commit' }
          & { history: (
            { __typename?: 'CommitHistoryConnection' }
...
/**
 * __useMostTopTechQuery__
 *
 * To run a query within a React component, call `useMostTopTechQuery` and pass it any options that fit your needs.
 * When your component renders, `useMostTopTechQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMostTopTechQuery({
 *   variables: {
 *      queryString: // value for 'queryString'
 *   },
 * });
 */
export function useMostTopTechQuery(baseOptions?: Apollo.QueryHookOptions<MostTopTechQuery, MostTopTechQueryVariables>) {
        return Apollo.useQuery<MostTopTechQuery, MostTopTechQueryVariables>(MostTopTechDocument, baseOptions);
      }
export function useMostTopTechLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MostTopTechQuery, MostTopTechQueryVariables>) {
          return Apollo.useLazyQuery<MostTopTechQuery, MostTopTechQueryVariables>(MostTopTechDocument, baseOptions);
        }
